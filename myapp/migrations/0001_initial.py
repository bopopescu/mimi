# Generated by Django 2.0.6 on 2018-08-21 02:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_set', models.CharField(max_length=100, verbose_name='评论')),
            ],
            options={
                'verbose_name': '文章',
        ...
        migrations.AddField(
            model_name='article',
            name='category_name',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.Category', verbose_name='文章类型'),
        ),
        migrations.AddField(
            model_name='article',
            name='user',
